...
// Server
//===========================================
gulp.task('openServer', async function () {
	browserSync({
...
gulp.task('jsMain:build', async function(){
...
// Dist
// //===========================================
gulp.task('dist', gulp.series('clean:dist'), async function () {
	...
	gulp.src(path.build.img)
		.pipe(imagemin({
			progressive: true,
			svgoPlugins: gulp.series({removeViewBox: false}),
			use: gulp.series(imageminPngquant()),
			interlaced: true
		}))
...
gulp.task('watch', async function () {
  ...
  gulp.watch(path.build.icon, gulp.series('sprite:build'));
  gulp.watch(path.build.img).on('change', browserSync.reload);
  gulp.watch(path.build.image).on('change', browserSync.reload);
  gulp.watch(path.build.sass, gulp.series('sass:build'));
	gulp.watch(path.build.jsLib, gulp.series('js:build'));
  gulp.watch(path.build.jsPath + 'main.js', gulp.series('jsMain:build'));
  gulp.watch(path.build.js).on('change', browserSync.reload);
});
// ===========================================
gulp.task('watchHtml', async function () {
  gulp.watch(path.build.htmlRiggerFiles, gulp.series('html:build'));
  gulp.watch(path.build.fonts).on('change', browserSync.reload);
  gulp.watch(path.build.icon, gulp.series('sprite:build'));
  gulp.watch(path.build.img).on('change', browserSync.reload);
  gulp.watch(path.build.image).on('change', browserSync.reload);
...
// ===========================================
gulp.task('watchPug', async function () {
	gulp.watch(path.build.pug, gulp.series('pug:build'));
  gulp.watch(path.build.fonts).on('change', browserSync.reload);
  gulp.watch(path.build.icon, gulp.series('sprite:build'));
  gulp.watch(path.build.img).on('change', browserSync.reload);
  gulp.watch(path.build.image).on('change', browserSync.reload);
...
// ===========================================
gulp.task('watchPhp', async function () {
...
// Gulp task default
//===========================================
gulp.task('default', gulp.series('sprite:build','sass:build','js:build','jsMain:build','webServer','watch'));
//===========================================
gulp.task('html', gulp.series('html:build','sprite:build','sass:build','js:build','jsMain:build','webServer','watchHtml'));
//===========================================
gulp.task('pug', gulp.series('pug:build','sprite:build','sass:build','js:build','jsMain:build','webServer','watchPug'));
//===========================================
gulp.task('php', gulp.series('sprite:build','sass:build','js:build','jsMain:build','openServer','watchPhp')); // only with php server
//===========================================
